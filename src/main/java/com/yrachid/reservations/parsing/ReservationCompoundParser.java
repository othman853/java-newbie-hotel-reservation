...
public class ReservationCompoundParser implements PatternParser<Optional<Reservation>>{
    ...
    private PatternParser<Collection<GregorianCalendar>> dateChainParser;

    public ReservationCompoundParser(PatternParser<CustomerType> customerTypeParser, PatternParser<Collection<GregorianCalendar>> dateChainParser) {
